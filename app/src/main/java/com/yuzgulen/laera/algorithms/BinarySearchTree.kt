...
class BinarySearchTree (
     ...
     * @param value
     */
    fun find(value: Int): BinarySearchTree? = when {
     ...
     */
    private fun scan(value: Int, node: BinarySearchTree?, parent: BinarySearchTree?) {
        if (node == null) {
     ...
     */
    private fun removeNode(node: BinarySearchTree, parent: BinarySearchTree?) {
     ...
     * @param parent
     */
    private fun removeNoChildNode(node: BinarySearchTree, parent: BinarySearchTree?) {
        parent?.let { p ->
            if (node == p.left) {
                p.left = null
     ...
     */
    private fun removeTwoChildNode(node: BinarySearchTree) {
     ...
     * @param n
     */
    private fun findParentOfMaxChild(n: BinarySearchTree): BinarySearchTree {
     ...
     */
    private fun removeSingleChildNode(parent: BinarySearchTree, child: BinarySearchTree) {
